 ...
 */
public class PWProgressMonitor extends Object
{
    private PWProgressMonitor root;
    ...
    private class ProgressOptionPane extends JOptionPane
    {
        ProgressOptionPane(Object messageList) {
            super(messageList,
                  ...
                  null,
                  PWProgressMonitor.this.cancelOption,
                  null);
        }
...
//   public void disableCancelButton() { // added will taylor
//     if (pane != null) {
//       System.err.println( "disableCancelButton " +  pane.getOptions()[0]);
//       // ((JButton) pane.getOptions()[0]).setEnabled( false);
//       Component [] components = pane.getRootPane().getComponents();
//       for (int i = 0, n = components.length; i < n; i++) {
//         Component component = (Component) components[i];
//         System.err.println( "component " + component.getClass().getName());
//         if (component instanceof JLayeredPane) {
//           Component [] panelComponents = ((JLayeredPane) component).getComponents();
//           for (int j = 0, m = panelComponents.length; j < m; j++) {
//             Component panelComponent = (Component) panelComponents[j];
//             System.err.println( "panelComponent " + panelComponent.getClass().getName());
//             if (panelComponent instanceof JPanel) {
//               Component [] panelComponents2 = ((JPanel) panelComponent).getComponents();
//               for (int k = 0, o = panelComponents.length; k < o; k++) {
//                 Component panelComponent2 = (Component) panelComponents2[k];
//                 System.err.println( "panelComponent2 " + panelComponent2.getClass().getName());
//                 if (panelComponent2 instanceof
//                     gov.nasa.arc.planworks.viz.util.PWProgressMonitor.ProgressOptionPane) {
//                   Component [] panelComponents3 =
//                     ((gov.nasa.arc.planworks.viz.util.PWProgressMonitor.ProgressOptionPane)
//                      panelComponent2).getComponents();
//                   for (int kk = 0, oo = panelComponents.length; kk < oo; kk++) {
//                     Component panelComponent3 = (Component) panelComponents3[kk];
//                     System.err.println( "panelComponent3 " +
//                                         panelComponent3.getClass().getName());
//                     if (panelComponent3 instanceof JPanel) {
//                       Component [] panelComponents4 =
//                         ((JPanel)  panelComponent3).getComponents();
//                       for (int kkk = 0, ooo = panelComponents.length; kkk < ooo; kkk++) {
//                         Component panelComponent4 = (Component) panelComponents4[kkk];
//                         System.err.println( "panelComponent4 " +
//                                         panelComponent4.getClass().getName());
//                         // javax.swing.plaf.basic.BasicOptionPaneUI$3
//                         // getButtons is protected -- damn!
//                       }
//                     }
//                   }
//                 }
...
//       }
//     } else {
//       System.err.println( " PWProgressMonitor.disableCancelButton: pane is null");
//     }
//   }

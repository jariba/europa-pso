...
// 
// $Id: TransactionView.java,v 1.1 2003-10-16 21:40:41 taylor Exp $
//
// PlanWorks
//
...
public class TransactionView extends PartialPlanView {
  ...
  public void init() {
    ...
    headerJGoView = new TransactionHeaderView( this);
...
//                             contentJGoView.getHorizontalScrollBar().getValue());
  ...
  /**
   * <code>TransactionJGoView</code> - subclass JGoView to add doBackgroundClick
   *
   */
  class TransactionJGoView extends JGoView {

    /**
     * <code>TransactionJGoView</code> - constructor 
     *
     */
    public TransactionJGoView() {
      super();
    }
  ...
  } // end class TransactionJGoView


  private class TransactionIdComparator implements Comparator {

...
From an application developerÕs view-point, the modules of interest are: {\em NDDL}, {\em Solvers} and \comment{JRB: UI and eclipse tools?}. These modules address modeling, search and troubleshooting respectively. Other modules will be explored in the context of making customized extensions.
...
\comment{JRB: should we try to embed the figure for each domain after its description?}

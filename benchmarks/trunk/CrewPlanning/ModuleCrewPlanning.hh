#ifndef _H_ModuleCrewPlanning
#define _H_ModuleCrewPlanning

#include "Module.hh"

namespace EUROPA {
  class ModuleCrewPlanning : public Module
  {
    public:
      ModuleCrewPlanning();
      virtual ~ModuleCrewPlanning();
  ...
  typedef Id<ModuleCrewPlanning> ModuleCrewPlanningId;  
}  


#endif /* #ifndef _H_ModuleCrewPlanning */
